...
public class CompactDisc extends Disc implements Playable {
    ...
    public CompactDisc(String title, String category, String director, float cost, String artist) throws Exception {
    ...
    public void play() throws PlayerException {
        ...
        }else{throw new PlayerException("ERROR: CD's length is non-positive","Can not play this CD");}
    }
